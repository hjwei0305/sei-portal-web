  ...
  a && Object.deepExtend(i, a),
    ...
    (i.fn.modes.repulseParticle = function(e) {
      ...
      if (
        ...
        var t = e.x - i.interactivity.mouse.pos_x;
          ...
          var o = 100;
          var l = clamp((1 / c) * (-1 * Math.pow(n / c, 2) + 1) * c * o, 0, 50);
          var v = { x: e.x + r.x * l, y: e.y + r.y * l };
        i.particles.move.out_mode == 'bounce'
    ...
    (i.fn.vendors.createSvgImg = function(e) {
      let a = i.tmp.source_svg;
        var t = /#([0-9A-F]{3,6})/gi;
        var s = a.replace(t, function(a, t, i, s) {
          if (e.color.rgb)
            var n =
              'rgba(' +
              e.color.rgb.r +
